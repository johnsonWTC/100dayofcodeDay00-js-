...
namespace Showie.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Name,isSubsribedToNewsLetter,MemberShipTypeId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,isSubsribedToNewsLetter,MemberShipTypeId")] Customer customer)
        {
            if (id != customer.id)
            {
                return NotFound();
